        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-24">
            ...
            <div className="bg-[#131b2f] p-8 rounded-2xl shadow-sm border border-white/5 hover:border-[#79c7fd]/30 transition-colors hover:shadow-xl transition-all">
              <Search className="text-[#6b84ec] w-10 h-10 mb-6" />
            ...
            {/* SEM */}
            <div className="bg-[#131b2f] p-8 rounded-2xl shadow-sm border border-white/5 hover:border-[#79c7fd]/30 transition-colors hover:shadow-xl transition-all">
              <TrendingUp className="text-[#6b84ec] w-10 h-10 mb-6" />
            ...
            {/* SMM */}
            <div className="bg-[#131b2f] p-8 rounded-2xl shadow-sm border border-white/5 hover:border-[#79c7fd]/30 transition-colors hover:shadow-xl transition-all">
              <Share2 className="text-[#6b84ec] w-10 h-10 mb-6" />
            ...
            {/* Lead Generation */}
            <div className="bg-[#131b2f] p-8 rounded-2xl shadow-sm border border-white/5 hover:border-[#79c7fd]/30 transition-colors hover:shadow-xl transition-all">
              <Target className="text-[#6b84ec] w-10 h-10 mb-6" />
            ...
            {/* Content Writing */}
            <div className="bg-[#131b2f] p-8 rounded-2xl shadow-sm border border-white/5 hover:border-[#79c7fd]/30 transition-colors hover:shadow-xl transition-all">
              <PenTool className="text-[#6b84ec] w-10 h-10 mb-6" />
            ...
            {/* Email Marketing */}
            <div className="bg-[#131b2f] p-8 rounded-2xl shadow-sm border border-white/5 hover:border-[#79c7fd]/30 transition-colors hover:shadow-xl transition-all">
              <Mail className="text-[#6b84ec] w-10 h-10 mb-6" />
          ...
          <div className="mb-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <div key={idx} className="bg-[#131b2f] p-6 rounded-xl border border-white/5 hover:border-[#79c7fd]/30 transition-colors shadow-sm">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            <div className="bg-[#131b2f] p-10 rounded-3xl shadow-lg border border-white/5">
              ...
              <ul className="space-y-6">
                <li className="flex items-center text-lg text-gray-300"><span className="w-8 h-8 rounded-full bg-[#79c7fd] text-white flex items-center justify-center font-bold mr-4">1</span> Understand your business goals</li>
                <li className="flex items-center text-lg text-gray-300"><span className="w-8 h-8 rounded-full bg-[#79c7fd] text-white flex items-center justify-center font-bold mr-4">2</span> Analyze market and competitors</li>
                <li className="flex items-center text-lg text-gray-300"><span className="w-8 h-8 rounded-full bg-[#79c7fd] text-white flex items-center justify-center font-bold mr-4">3</span> Create customized strategies</li>
                <li className="flex items-center text-lg text-gray-300"><span className="w-8 h-8 rounded-full bg-[#79c7fd] text-white flex items-center justify-center font-bold mr-4">4</span> Execute and optimize campaigns</li>
                <li className="flex items-center text-lg text-gray-300"><span className="w-8 h-8 rounded-full bg-[#79c7fd] text-white flex items-center justify-center font-bold mr-4">5</span> Deliver measurable results</li>
              </ul>
            </div>
            <div className="bg-gradient-to-br from-[#131b2f] to-[#070a12] p-10 rounded-3xl shadow-lg text-white border border-white/10">
              <h3 className="text-3xl font-bold mb-8 text-[#79c7fd]">Why Choose Our Digital Marketing</h3>
              <ul className="space-y-6">
                <li className="flex items-center text-lg"><CheckCircle className="text-[#6b84ec] mr-4 w-6 h-6" /> Data-driven strategies</li>
                <li className="flex items-center text-lg"><CheckCircle className="text-[#6b84ec] mr-4 w-6 h-6" /> ROI-focused campaigns</li>
                <li className="flex items-center text-lg"><CheckCircle className="text-[#6b84ec] mr-4 w-6 h-6" /> Customized marketing plans</li>
                <li className="flex items-center text-lg"><CheckCircle className="text-[#6b84ec] mr-4 w-6 h-6" /> Multi-channel expertise</li>
                <li className="flex items-center text-lg"><CheckCircle className="text-[#6b84ec] mr-4 w-6 h-6" /> Continuous optimization</li>
              </ul>
              <div className="mt-12">
