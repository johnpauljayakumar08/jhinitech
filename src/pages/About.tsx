...
export default function About() {
  return (
    <div className="bg-[#16062B] text-gray-300">
      {/* Hero Banner */}
      <section className="relative py-24 overflow-hidden bg-gradient-dark-purple">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-[#9B75C9] rounded-full mix-blend-screen filter blur-[150px] opacity-20"></div>
      ...
      {/* Story Section */}
      <section className="py-24 bg-[#110422] border-y border-white/5">
      ...
      <section className="py-24 bg-[#16062B]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
            <div className="bg-[#320E5E]/40 p-12 rounded-3xl border border-white/5 hover:border-[#9B75C9]/50 transition-colors relative overflow-hidden group">
              ...
              <Target className="text-[#CBB6E6] w-16 h-16 mb-8 relative z-10" />
            ...
            <div className="bg-[#320E5E]/40 p-12 rounded-3xl border border-white/5 hover:border-[#CBB6E6]/50 transition-colors relative overflow-hidden group">
              <div className="absolute top-0 right-0 w-32 h-32 bg-[#CBB6E6] rounded-full mix-blend-screen filter blur-[64px] opacity-0 group-hover:opacity-20 transition-opacity"></div>
              <Eye className="text-[#CBB6E6] w-16 h-16 mb-8 relative z-10" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div key={idx} className="bg-[#320E5E]/40 p-8 rounded-2xl border border-white/5 hover:border-[#9B75C9]/30 hover:shadow-purple-glow transition-all group">
                <CheckCircle className="text-[#CBB6E6] w-10 h-10 mb-6 group-hover:scale-110 transition-transform" />
      ...
      <section className="py-24 bg-[#16062B]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-[#320E5E]/40 rounded-3xl p-12 shadow-2xl border border-white/10 relative overflow-hidden">
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[#9B75C9] rounded-full mix-blend-screen filter blur-[200px] opacity-10"></div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 relative z-10">
              {[
                ...
                <div key={idx} className="flex items-center p-4 bg-[#16062B] rounded-xl border border-white/5">
                  <Zap className="text-[#CBB6E6] w-6 h-6 mr-4 flex-shrink-0" />
            ...
            <div className="mt-16 text-center relative z-10">
              <p className="text-2xl font-medium text-[#CBB6E6] italic border-t border-b border-white/10 py-8 bg-[#16062B]/30 rounded-lg">
