        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-24">
            {[
              ...
              <div key={idx} className="bg-[#320E5E]/40 p-6 rounded-2xl shadow-sm border border-white/5 text-center relative">
                <div className="w-12 h-12 bg-[#16062B] border border-white/5 text-[#9B75C9] rounded-full flex items-center justify-center text-xl font-bold mx-auto mb-4">
                  {idx + 1}
                </div>
          ...
          <div className="mb-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-[#320E5E]/40 p-8 rounded-2xl shadow-sm border border-white/5 hover:border-[#CBB6E6]/30 transition-colors hover:shadow-xl transition-all">
                <Code className="text-[#9B75C9] w-10 h-10 mb-6" />
              ...
              <div className="bg-[#320E5E]/40 p-8 rounded-2xl shadow-sm border border-white/5 hover:border-[#CBB6E6]/30 transition-colors hover:shadow-xl transition-all">
                <Globe className="text-[#9B75C9] w-10 h-10 mb-6" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-24">
            <div className="bg-[#320E5E]/40 p-10 rounded-3xl shadow-lg border border-white/5">
              <div className="flex items-center mb-8">
                <MessageSquare className="text-[#9B75C9] w-10 h-10 mr-4" />
              ...
              <ul className="space-y-3 text-gray-400">
                <li className="flex items-start"><CheckCircle className="text-[#CBB6E6] w-5 h-5 mr-3 mt-1 flex-shrink-0" /> Spoken English</li>
                <li className="flex items-start"><CheckCircle className="text-[#CBB6E6] w-5 h-5 mr-3 mt-1 flex-shrink-0" /> Business communication</li>
                <li className="flex items-start"><CheckCircle className="text-[#CBB6E6] w-5 h-5 mr-3 mt-1 flex-shrink-0" /> Presentation skills</li>
                <li className="flex items-start"><CheckCircle className="text-[#CBB6E6] w-5 h-5 mr-3 mt-1 flex-shrink-0" /> Group discussion training</li>
                <li className="flex items-start"><CheckCircle className="text-[#CBB6E6] w-5 h-5 mr-3 mt-1 flex-shrink-0" /> Confidence building</li>
              </ul>
            </div>
            <div className="bg-[#320E5E]/40 p-10 rounded-3xl shadow-lg border border-white/5">
              <div className="flex items-center mb-8">
              ...
              <ul className="space-y-3 text-gray-400">
                <li className="flex items-start"><CheckCircle className="text-[#CBB6E6] w-5 h-5 mr-3 mt-1 flex-shrink-0" /> Quantitative aptitude</li>
                <li className="flex items-start"><CheckCircle className="text-[#CBB6E6] w-5 h-5 mr-3 mt-1 flex-shrink-0" /> Logical reasoning</li>
                <li className="flex items-start"><CheckCircle className="text-[#CBB6E6] w-5 h-5 mr-3 mt-1 flex-shrink-0" /> Analytical thinking</li>
                <li className="flex items-start"><CheckCircle className="text-[#CBB6E6] w-5 h-5 mr-3 mt-1 flex-shrink-0" /> Problem-solving techniques</li>
              </ul>
            </div>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-24">
            <div className="bg-gradient-dark-purple border border-white/10 p-8 rounded-3xl shadow-lg text-white">
              <h3 className="text-2xl font-bold mb-6 text-[#CBB6E6]">Real-Time Project Experience</h3>
              <p className="text-gray-400 mb-6 text-sm">Students gain practical exposure by working on live projects such as:</p>
              <ul className="space-y-3 text-gray-300 text-sm">
                <li className="flex items-start"><CheckCircle className="text-[#9B75C9] w-5 h-5 mr-3 mt-1 flex-shrink-0" /> Web development projects</li>
                <li className="flex items-start"><CheckCircle className="text-[#9B75C9] w-5 h-5 mr-3 mt-1 flex-shrink-0" /> Digital marketing campaigns</li>
                <li className="flex items-start"><CheckCircle className="text-[#9B75C9] w-5 h-5 mr-3 mt-1 flex-shrink-0" /> UI/UX design projects</li>
                <li className="flex items-start"><CheckCircle className="text-[#9B75C9] w-5 h-5 mr-3 mt-1 flex-shrink-0" /> ERP system implementation</li>
              </ul>
            </div>
            <div className="bg-gradient-dark-purple border border-white/10 p-8 rounded-3xl shadow-lg text-white">
              <h3 className="text-2xl font-bold mb-6 text-[#CBB6E6]">Interview Preparation</h3>
              <p className="text-gray-400 mb-6 text-sm">Students are trained to confidently face real interviews.</p>
              <ul className="space-y-3 text-gray-300 text-sm">
                <li className="flex items-start"><CheckCircle className="text-[#9B75C9] w-5 h-5 mr-3 mt-1 flex-shrink-0" /> Resume building and profile development</li>
                <li className="flex items-start"><CheckCircle className="text-[#9B75C9] w-5 h-5 mr-3 mt-1 flex-shrink-0" /> Mock interviews (HR, technical, GD)</li>
                <li className="flex items-start"><CheckCircle className="text-[#9B75C9] w-5 h-5 mr-3 mt-1 flex-shrink-0" /> AI-based interview practice</li>
                <li className="flex items-start"><CheckCircle className="text-[#9B75C9] w-5 h-5 mr-3 mt-1 flex-shrink-0" /> Performance feedback</li>
              </ul>
            </div>
            <div className="bg-gradient-dark-purple border border-white/10 p-8 rounded-3xl shadow-lg text-white">
              <h3 className="text-2xl font-bold mb-6 text-[#CBB6E6]">Placement Support</h3>
              <p className="text-gray-400 mb-6 text-sm">We support students in securing the right career opportunities.</p>
              <ul className="space-y-3 text-gray-300 text-sm">
                <li className="flex items-start"><CheckCircle className="text-[#9B75C9] w-5 h-5 mr-3 mt-1 flex-shrink-0" /> Job readiness training</li>
                <li className="flex items-start"><CheckCircle className="text-[#9B75C9] w-5 h-5 mr-3 mt-1 flex-shrink-0" /> Internship opportunities</li>
                <li className="flex items-start"><CheckCircle className="text-[#9B75C9] w-5 h-5 mr-3 mt-1 flex-shrink-0" /> Career guidance and mentoring</li>
                <li className="flex items-start"><CheckCircle className="text-[#9B75C9] w-5 h-5 mr-3 mt-1 flex-shrink-0" /> Industry exposure and connections</li>
              </ul>
            </div>
          </div>
