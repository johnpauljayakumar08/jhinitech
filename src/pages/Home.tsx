  ...
  return (
    <div className="bg-[#0b0f19] text-gray-300">
      ...
      <section className="relative py-32 overflow-hidden">
        ...
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-[#6b84ec] rounded-full mix-blend-screen filter blur-[128px] opacity-30 animate-pulse"></div>
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-[#79c7fd] rounded-full mix-blend-screen filter blur-[128px] opacity-20 animate-pulse" style={{ animationDelay: '2s' }}></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          >
            <Link to="/contact" className="inline-flex items-center justify-center px-8 py-4 text-lg font-semibold rounded-full bg-gradient-to-r from-[#6b84ec] to-[#79c7fd] text-white hover:opacity-90 transition-all shadow-[0_0_30px_rgba(107,132,236,0.3)] hover:shadow-[0_0_40px_rgba(107,132,236,0.5)] hover:-translate-y-1">
              Enquire Now
      ...
      {/* About Us Section */}
      <section className="py-24 bg-[#070a12] relative border-y border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-xl font-medium text-[#79c7fd] italic border-l-4 border-[#6b84ec] pl-6 py-2 bg-white/5 rounded-r-lg">
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-8 -left-8 bg-[#131b2f] p-6 rounded-xl shadow-2xl border border-white/10 hidden md:block">
                <div className="flex items-center gap-4">
                  <div className="bg-[#6b84ec]/20 p-4 rounded-full text-[#79c7fd]">
                    <Briefcase size={32} />
                  </div>
                  <div>
      ...
      <section className="py-24 bg-[#0b0f19]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <div className="w-24 h-1 bg-gradient-to-r from-[#6b84ec] to-[#79c7fd] mx-auto rounded-full"></div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <Link to={service.path} key={idx} className="bg-[#131b2f] rounded-2xl p-8 shadow-lg hover:shadow-[0_0_20px_rgba(107,132,236,0.15)] transition-all border border-white/5 hover:border-[#6b84ec]/50 group relative overflow-hidden">
                ...
                <h3 className="text-2xl font-bold text-white mb-4 group-hover:text-[#79c7fd] transition-colors relative z-10">{service.title}</h3>
                <p className="text-gray-400 mb-6 leading-relaxed relative z-10">{service.desc}</p>
                <span className="inline-flex items-center text-[#6b84ec] font-semibold group-hover:text-[#79c7fd] relative z-10">
      ...
      <section className="py-20 bg-[#070a12] border-y border-white/5 relative overflow-hidden">
        <div className="absolute left-0 top-1/2 -translate-y-1/2 w-64 h-64 bg-[#79c7fd] rounded-full mix-blend-screen filter blur-[100px] opacity-10"></div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="bg-[#131b2f] rounded-3xl p-8 md:p-12 border border-white/10 shadow-2xl">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <ul className="space-y-4">
                  <li className="flex items-center text-gray-300"><CheckCircle className="text-[#79c7fd] mr-3" /> Full feature access</li>
                  <li className="flex items-center text-gray-300"><CheckCircle className="text-[#79c7fd] mr-3" /> Guided walkthrough available</li>
                  <li className="flex items-center text-gray-300"><CheckCircle className="text-[#79c7fd] mr-3" /> No credit card required</li>
                </ul>
              </div>
              <div className="bg-[#0b0f19] rounded-2xl p-8 border border-white/5 shadow-xl">
                <form className="space-y-5">
                  <div>
                    <label className="block text-sm font-medium text-gray-400 mb-1">Name</label>
                    <input type="text" className="w-full px-4 py-3 rounded-lg bg-[#131b2f] border border-white/10 text-white focus:ring-2 focus:ring-[#6b84ec] focus:border-transparent outline-none transition-all" placeholder="John Doe" />
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                      <label className="block text-sm font-medium text-gray-400 mb-1">Phone Number</label>
                      <input type="tel" className="w-full px-4 py-3 rounded-lg bg-[#131b2f] border border-white/10 text-white focus:ring-2 focus:ring-[#6b84ec] focus:border-transparent outline-none transition-all" placeholder="+1 234 567 890" />
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-gray-400 mb-1">Email ID</label>
                      <input type="email" className="w-full px-4 py-3 rounded-lg bg-[#131b2f] border border-white/10 text-white focus:ring-2 focus:ring-[#6b84ec] focus:border-transparent outline-none transition-all" placeholder="john@company.com" />
                    </div>
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-400 mb-1">Company Name</label>
                    <input type="text" className="w-full px-4 py-3 rounded-lg bg-[#131b2f] border border-white/10 text-white focus:ring-2 focus:ring-[#6b84ec] focus:border-transparent outline-none transition-all" placeholder="Your Company" />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-400 mb-1">Select the logins needed for</label>
                    <select className="w-full px-4 py-3 rounded-lg bg-[#131b2f] border border-white/10 text-white focus:ring-2 focus:ring-[#6b84ec] focus:border-transparent outline-none transition-all">
                      <option>ERP</option>
                      <option>LMS</option>
                      <option>Both ERP & LMS</option>
                    </select>
                  </div>
                  <button type="button" className="w-full bg-gradient-to-r from-[#6b84ec] to-[#79c7fd] hover:opacity-90 text-white font-bold py-4 px-8 rounded-lg transition-colors shadow-lg mt-4">
                    Submit Request
                  </button>
                </form>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            {[
              ...
              <div key={idx} className="flex items-start p-6 rounded-2xl bg-[#131b2f] hover:bg-[#1a233a] transition-colors border border-white/5">
                <CheckCircle className="text-[#79c7fd] mt-1 flex-shrink-0" size={24} />
                <div className="ml-4">
      ...
      {/* Stats */}
      <section className="py-20 bg-[#070a12] border-y border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              <div className="text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-[#6b84ec] to-[#79c7fd] mb-2">100+</div>
              <div className="text-lg text-gray-400 font-medium">Satisfied Clients</div>
            </div>
            <div>
              <div className="text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-[#6b84ec] to-[#79c7fd] mb-2">200+</div>
              <div className="text-lg text-gray-400 font-medium">Projects Delivered</div>
            </div>
            <div>
              <div className="text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-[#6b84ec] to-[#79c7fd] mb-2">15+</div>
      ...
      <section className="py-24 bg-[#0b0f19]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="w-24 h-1 bg-gradient-to-r from-[#6b84ec] to-[#79c7fd] mx-auto rounded-full mb-16"></div>
          <div className="flex flex-wrap justify-center gap-8 md:gap-16 items-center opacity-50 hover:opacity-100 transition-opacity duration-500">
            {['Curiomod', 'Lord Minds', 'Ruffins', 'Raahat Ansaar', 'Royal Dessert', 'Curio Trade', 'Arkayuga', 'Karthik ERP'].map((client, idx) => (
              <div key={idx} className="text-2xl font-bold text-gray-500 hover:text-[#79c7fd] transition-colors px-4 py-2">
                {client}
              </div>
            ))}
          </div>
      ...
      {/* FAQs */}
      <section className="py-24 bg-[#070a12] border-t border-white/5">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            {[
              ...
              <div key={idx} className="bg-[#131b2f] rounded-xl p-6 shadow-sm border border-white/5">
