...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen flex flex-col font-sans text-gray-300 bg-[#0b0f19]">
      {/* Navbar */}
      <header className="bg-[#0b0f19]/80 backdrop-blur-md border-b border-white/10 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-20 items-center">
            <div className="flex-shrink-0 flex items-center">
              <Link to="/" className="text-2xl font-bold text-[#6b84ec]">
                Jhini<span className="text-[#79c7fd]">Tech</span>
              </Link>
            </div>
            ...
            <nav className="hidden xl:flex space-x-6">
              {navLinks.map((link) => (
                <Link
                  key={link.name}
                  to={link.path}
                  className="text-sm font-medium text-gray-300 hover:text-[#79c7fd] transition-colors"
                >
                  {link.name}
                </Link>
              ))}
            ...
            <div className="xl:hidden flex items-center">
              <button
                ...
                className="text-gray-300 hover:text-[#79c7fd] focus:outline-none"
              >
        ...
        {/* Mobile Menu */}
        {isMenuOpen && (
          <div className="xl:hidden bg-[#131b2f] border-t border-white/10">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              {navLinks.map((link) => (
                <Link
                  ...
                  className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:text-[#79c7fd] hover:bg-white/5"
                >
                  {link.name}
                </Link>
              ))}
      ...
      <div className="fixed bottom-6 right-6 flex flex-col gap-4 z-50">
        ...
        <a href="tel:+1234567890" className="bg-[#6b84ec] text-white p-3 rounded-full shadow-lg hover:bg-blue-700 transition-transform hover:scale-110">
          <Phone size={24} />
        </a>
      </div>

      {/* Footer */}
      <footer className="bg-[#070a12] border-t border-white/10 text-gray-400 pt-16 pb-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            <div>
              <h3 className="text-lg font-semibold mb-6 text-[#79c7fd]">Quick Links</h3>
            ...
            <div>
              <h3 className="text-lg font-semibold mb-6 text-[#79c7fd]">Services</h3>
              <ul className="space-y-3">
            ...
            <div>
              <h3 className="text-lg font-semibold mb-6 text-[#79c7fd]">Contact Info</h3>
              <ul className="space-y-3">
